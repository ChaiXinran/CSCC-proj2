...
The first merge must be the contract branch. No group should start large feature changes before `docs/native-v12-interface.md` is accepted.
...
| `reports/v12-part*.md`         | each group | Every change updates the matching report                                            |
| `docs/native-v12-interface.md` | all groups | Shared contracts are authoritative                                                  |
...
```text
docs/native-v12-team-plan.md
docs/native-v12-interface.md
reports/v12-partA-report.md
reports/v12-partB-report.md
reports/v12-partC-report.md
reports/native-v12-scan-failures.txt
reports/native-v12-scan-summary.json
reports/native-v12-test262-analysis.md
```
...
```powershell
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test --jobs 4 --progress --json reports/native-v12-full-test262-summary.json
```
...
```powershell
cargo run --release --no-default-features -- test262 --native-v12-scan --jobs 4 --json reports/native-v12-scan-summary.json
```
