...
If P1 needs one of those files, write the requested interface change in `docs/fixup-interface.md` first and ask the owner to land the contract.
...
Before modifying these files, update `docs/fixup-interface.md` or notify the owner:
...
```text
reports/fixup8-scan-failures.txt
...
```powershell
cargo run --release --no-default-features -- test262 --native-fixup8-scan --jobs 4 --json reports/fixup8-scan-summary.json
```
...
2. Add docs/fixup-interface.md
3. Add reports/fixup8-p1-report.md
4. Add reports/fixup8-p2-report.md
5. Add reports/fixup8-p3-report.md
6. Generate reports/fixup8-scan-failures.txt
