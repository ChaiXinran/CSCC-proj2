...
| `reports/fix4-part*.md`         | 各组                        | 每个 PR 更新对应报告                                                  |
| `docs/fix4-shared-interface.md` | 全组                        | 所有共享接口变化先写文档再改代码                                              |
...
```text
reports/native-fix4-scan-failures.txt
reports/native-fix4-scan-summary.json
```
...
```text
reports/fix4-partA-report.md
reports/fix4-partB-report.md
reports/fix4-partC-report.md
...
```powershell
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test --jobs 4 --progress --json reports/fix4-full-test262-summary.json
```
...
```text
docs/fix4-team-plan.md
docs/fix4-shared-interface.md
reports/fix4-partA-report.md
reports/fix4-partB-report.md
reports/fix4-partC-report.md
```
...
| ---------- | --- | ------------------------------------------------------ | --------------------------------------------------------- | --- | --------------------------- |
| 2026-06-27 | 全组  | 建立 Fix4 分工和共享接口                                        | `docs/fix4-team-plan.md`, `docs/fix4-shared-interface.md` | 待定  | 文档变更                        |
