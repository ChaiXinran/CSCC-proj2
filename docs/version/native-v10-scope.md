...
```sh
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test/language/literals --jobs 4 --progress --json reports/.native-test262-tmp/native-v10-a-literals-summary.json
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test/language/identifiers --jobs 4 --progress --json reports/.native-test262-tmp/native-v10-a-identifiers-summary.json
```

### V10-B

```sh
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test/built-ins/TypedArray --jobs 4 --progress --json reports/.native-test262-tmp/native-v10-b-typedarray-summary.json
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test/built-ins/DataView --jobs 4 --progress --json reports/.native-test262-tmp/native-v10-b-dataview-summary.json
```

### V10-C

```sh
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test/built-ins/Date --jobs 4 --progress --json reports/.native-test262-tmp/native-v10-c-date-summary.json
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test/intl402 --jobs 4 --progress --json reports/.native-test262-tmp/native-v10-c-intl402-summary.json
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test/built-ins/Temporal --jobs 4 --progress --json reports/.native-test262-tmp/native-v10-c-temporal-summary.json
```
