...
| `docs/version/native-v7-*.md` | D after contracts merge |
...
cargo run --release --no-default-features -- test262 --native-v7-scan --jobs 4 --json reports/.native-test262-tmp/native-v7-parser_basics-summary.json
```
