...
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test/language/statements/for-await-of --jobs 4 --progress --json reports/.native-test262-tmp/native-v9-a-forawait-summary.json
```
...
cargo run --release --no-default-features -- test262 --backend native --root test262 --suite test/built-ins/Iterator --jobs 4 --progress --json reports/.native-test262-tmp/native-v9-c-iterator-summary.json
```
