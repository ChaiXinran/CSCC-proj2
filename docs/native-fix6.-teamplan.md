...
| `reports/v12-part*.md`         | track owners | Every code change updates the matching report                     |
| `docs/native-v12-interface.md` | all          | Interface authority                                               |
...
reports/fixbug6-test262-analysis.md
docs/status.md
```
...
```text
A changes -> reports/v12-partA-report.md
B changes -> reports/v12-partB-report.md
C changes -> reports/v12-partC-report.md
D changes -> reports/native-v12-scan-summary.json or integration report
```
