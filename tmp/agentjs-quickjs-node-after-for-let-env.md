...
- Label: `agentjs-quickjs-node-after-for-let-env`
- Engine: `C:\Users\36123\Desktop\OS 功能赛\CSCC-proj2\target\release\agentjs.exe jetstream`
- Result: **0/5 passed**

| Case | Status | Time ms |
|:---|:---|---:|
| quickjs\tests\test_closure.js | runtime-error | 220.5 |
| quickjs\tests\test_language.js | syntax-error | 14.4 |
| quickjs\tests\test_builtin.js | syntax-error | 14.4 |
| quickjs\tests\test_loop.js | runtime-error | 11.7 |
| quickjs\tests\test_bigint.js | runtime-error | 11.1 |
