function assert(actual, expected, message) {
    ...
    throw "assertion failed: got |" + actual + "|, expected |" + expected + "|" + (message ? " (" + message + ")" : "");
}
...
function assert_throws(expected_error, func)
{
    ...
    try {
        ...
        if (!(e instanceof expected_error)) {
            throw "unexpected exception type:" + e;
        }
    }
    if (!err) {
...
var __tests = [["test_op1",test_op1],["test_cvt",test_cvt],["test_eq",test_eq],["test_inc_dec",test_inc_dec],["test_op2",test_op2],["test_constructor",test_constructor],["test_delete",test_delete],["test_prototype",test_prototype],["test_arguments",test_arguments],["test_class",test_class],["test_template",test_template],["test_template_skip",test_template_skip],["test_object_literal",test_object_literal],["test_regexp_skip",test_regexp_skip],["test_labels",test_labels],["test_labels2",test_labels2],["test_destructuring",test_destructuring],["test_spread",test_spread],["test_function_length",test_function_length],["test_argument_scope",test_argument_scope],["test_function_expr_name",test_function_expr_name],["test_parse_semicolon",test_parse_semicolon],["test_optional_chaining",test_optional_chaining],["test_parse_arrow_function",test_parse_arrow_function],["test_unicode_ident",test_unicode_ident],["test_global_var_opt",test_global_var_opt],["test_number_literals",test_number_literals]];
for (var __i = 0; __i < __tests.length; __i++) {
  var __entry = __tests[__i];
  try { __entry[1](); }
  catch (e) { throw __entry[0] + ":" + e; }
}
