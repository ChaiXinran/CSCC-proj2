...
- Label: `agentjs-quickjs-node-after-super-fix`
- Engine: `C:\Users\36123\Desktop\OS 功能赛\CSCC-proj2\target\release\agentjs.exe jetstream`
- Result: **0/5 passed**

| Case | Status | Time ms |
|:---|:---|---:|
| quickjs\tests\test_closure.js | runtime-error | 239.7 |
| quickjs\tests\test_language.js | syntax-error | 12.1 |
| quickjs\tests\test_builtin.js | syntax-error | 14.6 |
| quickjs\tests\test_loop.js | runtime-error | 10.7 |
| quickjs\tests\test_bigint.js | runtime-error | 14.7 |
